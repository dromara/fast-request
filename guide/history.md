...
:::hint API Navigate 与 Methods tab 支持快速搜索&#x20;
...
:::hint SearchEveryWhere 支持带 context-path 路径的搜索&#x20;
...
:::hint Environment 与 Function 值高亮优化&#x20;
...
:::hint JSON key 支持一键转换驼峰&#x20;

![](/img/2025.1.9/jsonKeyCaseConversion.png)

支持对 JSON 数据中的 key 进行命名格式转换，可将字段名一键转换为 camelCase 驼峰格式，同时支持 snake\_case、kebab-case、PascalCase、SCREAMING\_SNAKE\_CASE 等多种常见命名风格
