...
However, we are at the point where we need to increase our subscription prices. The new prices will come into effect on ==January 1, 2023==. It will be adjusted from **$1/month** to **$1.9/month** and the annual subscription price will be 10 times the monthly subscription price (10 months).
