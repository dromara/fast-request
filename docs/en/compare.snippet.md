...
- [x] [<ColorIcon icon="doc" /> Online Document](/en/guide/features/onlineDocument.md)
- [x] [<ColorIcon icon="openai" /> AI Parameter Optimization](/en/guide/features/aiParameterOptimization.md)
- [x] [<ColorIcon icon="settings" /> AI](/en/guide/features/ai.md)
- [x] [<ColorIcon icon="apis" /> Batch API Generation](/en/guide/features/batchGenerateApi.md)
