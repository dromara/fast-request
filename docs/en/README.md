...
<div class="hint-container tip" style="width:50%; background: rgb(39 117 182 / 38%);border-color: rgb(39 117 182 / 38%);">
    ...
    <ul class="task-list-container" style="list-style-type: none;">
        <li class="task-list-item">
            ...
            <label class="task-list-item-label" >API generation(<b> user-friendly generation strategy</b>)</label>
        </li>
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <label class="task-list-item-label" >API manager</label>
        </li>
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <label class="task-list-item-label" >SearchEveryWhere(Support api name query)</label>
        </li>
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <label class="task-list-item-label" >cUrl copy</label>
        </li>
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <label class="task-list-item-label" >API navigate</label>
        </li>
<li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <a class="task-list-item-label"  href="/fast-request/en/guide/features/apiToPostman.html"><svg class="icon svg-icon" aria-hidden="true"><use xlink:href="#icon-postman"></use></svg> API export to Postman</a>
        </li>
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
        ...
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <a class="task-list-item-label"  href="/fast-request/en/guide/features/script.html"><svg class="icon svg-icon" aria-hidden="true"><use xlink:href="#icon-script"></use></svg> Script</a>
        </li>
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
        ...
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <a href="/fast-request/en/guide/features/projectLevelDomainConfig.html" class="task-list-item-label" ><svg class="icon svg-icon" aria-hidden="true"><use xlink:href="#icon-domainConfig"></use></svg> Yaml、Properties domain parse</a>
        </li>
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <a href="/fast-request/en/guide/features/stopRequest.html" class="task-list-item-label" ><svg class="icon svg-icon" aria-hidden="true"><use xlink:href="#icon-stop"></use></svg> Stop API request</a>
        </li>
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
        ...
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <a class="task-list-item-label" href="/fast-request/en/guide/features/apiGroup.html" ><svg class="icon svg-icon" aria-hidden="true"><use xlink:href="#icon-saveGroup"></use></svg><svg class="icon svg-icon" aria-hidden="true"><use xlink:href="#icon-apiParamGroup"></use></svg> API group</a>
        </li>
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
        ...
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <a href="/fast-request/en/guide/features/clear.html" class="task-list-item-label" ><svg class="icon svg-icon" aria-hidden="true"><use xlink:href="#icon-clear"></use></svg> Clear params</a>
        </li>
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
        ...
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <a href="/fast-request/en/guide/features/copyUrl.html" class="task-list-item-label" ><svg class="icon svg-icon" aria-hidden="true"><use xlink:href="#icon-urlCopy"></use></svg> Url copy</a>
        </li>
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
        ...
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <a href="/fast-request/en/guide/features/apiDocSync.html" class="task-list-item-label" ><svg class="icon svg-icon" aria-hidden="true"><use xlink:href="#icon-github"></use></svg> <svg class="icon svg-icon" aria-hidden="true"><use xlink:href="#icon-gitee"></use></svg> <svg class="icon svg-icon" aria-hidden="true"><use xlink:href="#icon-gitlab"></use></svg> API document sync</a>
        </li>
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
        ...
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <a href="/fast-request/en/guide/features/fullScreen.html" class="task-list-item-label" ><svg class="icon svg-icon" aria-hidden="true"><use xlink:href="#icon-fullScreen"></use></svg> FullScreen</a>
        </li>
<li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <a href="/fast-request/en/guide/features/commonHeader.html" class="task-list-item-label" ><svg class="icon svg-icon" aria-hidden="true"><use xlink:href="#icon-commonHeader"></use></svg> Common header</a>
        </li>
<li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <a href="/fast-request/en/guide/features/htmlPreview.html" class="task-list-item-label" ><svg class="icon svg-icon" aria-hidden="true"><use xlink:href="#icon-chrome"></use></svg> Html preview</a>
        </li>
<li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <a href="/fast-request/en/guide/features/apiImportExport.html" class="task-list-item-label" ><svg class="icon svg-icon" aria-hidden="true"><use xlink:href="#icon-export"></use></svg> APIs import and export</a>
        </li>
<li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
        ...
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <a href="/fast-request/en/guide/features/swaggerDefaultValueParse.html" class="task-list-item-label" ><svg class="icon svg-icon" aria-hidden="true"><use xlink:href="#icon-swagger"></use></svg> Swagger default value parsing support</a>
        </li>
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <a href="/fast-request/en/guide/features/autoDescription.html" class="task-list-item-label" ><svg class="icon svg-icon" aria-hidden="true"><use xlink:href="#icon-java"></use></svg> Auto Description</a>
        </li>
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <a href="/fast-request/en/guide/features/apiPreview.html" class="task-list-item-label" ><svg class="icon svg-icon" aria-hidden="true"><use xlink:href="#icon-restfulFastRequest"></use></svg> API list preview</a>
        </li>
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
        ...
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <a href="/fast-request/en/guide/features/autoDomain.html" class="task-list-item-label" ><svg class="icon svg-icon" aria-hidden="true"><use xlink:href="#icon-restfulFastRequest"></use></svg> Auto domain</a>
        </li>
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
        ...
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <a href="/fast-request/en/guide/features" class="task-list-item-label" > More...</a>
        </li>
    </ul>
</div>
...
<div class="hint-container info" style="width:50%; margin-left: 10px; background: rgb(11 249 186 / 18%);border-color:rgb(11 249 186 / 18%)">
    ...
    <ul class="task-list-container" style="list-style-type: none;">
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <label class="task-list-item-label" >API generation</label>
        </li>
        <li class="task-list-item">
            <input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled">
            <label class="task-list-item-label" >API manager</label>
