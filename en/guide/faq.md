...
1. Create a global .gitignore file: Choose a location to store the global .gitignore file, for example, create a file named .gitignore\_global in your home directory.
...
3. Edit the global .gitignore file: Add the file or directory patterns you want to ignore in the ~/.gitignore\_global file.
...
Please refer [ Project-level domain config](./features/projectLevelDomainConfig.md)
...
you need to click (save) or click  again and then sync api doc.
...
and you need to manually fill in the parameters and save  it.
If you don't want the parameters you saved before at all,
you can click ([Re generate](/guide/features/regenerate.md)).
...
3. Click on the icon  in the APIs tab and do transfer
