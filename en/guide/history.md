...
::: hint Required parameter detection and marking&#x20;
...
::: hint Quick search for API Navigate and saved methods&#x20;
...
::: hint Online Document parameter groups&#x20;
...
::: hint Custom environment synchronization for Online Document&#x20;
...
::: hint Improved Online Document synchronization, login, and parameter display&#x20;
...
::: hint Fixed Form parameter issues in Online Document&#x20;
...
::: hint Configurable API Navigate scan strategy&#x20;
...
::: hint AI Parameter Optimization&#x20;
...
::: hint Parameter editor optimization&#x20;
...
::: hint SearchEveryWhere supports searching paths with a context path&#x20;
...
::: hint Script supports direct references to local project classes&#x20;
...
::: hint Environment and Function value highlighting&#x20;
...
::: hint Fix minor non-blocking issues&#x20;
...
::: hint JSON key support one-click conversion

![](/img/2025.1.9/jsonKeyCaseConversion.png)

Support one-click conversion to camelCase, snake\_case, kebab-case, and pascalCase for JSON keys.
:::
