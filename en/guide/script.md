...
**Scope**: `Project-level` and `Single API level`，`Project-level` needs to click [ Project-level config](./features/projectValueConfig.md).
...
### 4.Reference a project class directly&#x20;
